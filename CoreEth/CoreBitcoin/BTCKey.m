...
// Duplicate of definition in internal openssl header "ec_lcl.h".
// Including "ec_lcl.h" in the openssl module (imported above), would drag in a lot of other (internal) headers,
// which is not a good thing.  It's unclear why an internal openssl definition is used here; seems wrong.
struct ECDSA_SIG_st {
    BIGNUM *r;
    BIGNUM *s;
};
